...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="tag fixed bottom-[5.25rem] right-5 z-30 inline-flex min-h-14 items-center gap-2.5 rounded-full bg-heat pl-4 pr-5 text-void shadow-xl shadow-heat/25 transition-transform duration-200 ease-out hover:scale-105 active:scale-[0.98] sm:right-8"
    >
