export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="tag fixed bottom-5 right-4 z-20 inline-flex min-h-14 items-center gap-2.5 rounded-full bg-ink pl-4 pr-5 text-deep shadow-lg shadow-deep/25 transition-transform duration-200 ease-out hover:scale-[1.03] active:scale-[0.98] sm:right-6"
    >
