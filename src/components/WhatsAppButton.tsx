export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-5 z-20 inline-flex min-h-14 items-center gap-2.5 rounded-full bg-ink pl-4 pr-5 text-[15px] font-medium text-white shadow-lg shadow-ink/20 transition-transform duration-200 ease-out hover:scale-[1.03] active:scale-[0.98] sm:right-8"
    >
